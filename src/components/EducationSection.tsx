...
const education = [
  ...
  {
    degree: 'Intermediate (SSC – 12th Grade), MPC',
    school: 'SR Junior College, Warangal, Telangana',
    year: '2022 – 2024',
  },
  {
    degree: 'High School (SSC – 10th Grade)',
    school: 'St. Peter\'s High School, Warangal, Telangana',
    year: 'Completed 2022',
  },
];
